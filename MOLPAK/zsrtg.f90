      SUBROUTINE ZSRTG                                                      
!                                                                                                                                              
!-----This routine finds structures in space group Pbca when the         
!      molecule contains a center of symmetry.  The coordination sphere  
!      contains 2 I molecules on axis-3. For SN.                                
!                                                                        
      USE molpakCommonMod
